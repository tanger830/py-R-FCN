...
import subprocess
import uuid
from vehicle_eval import vehicle_eval
...
class vehicle(imdb):
    def __init__(self, image_set, data_path=None):
        ...
        assert os.path.exists(self._data_path), \
                'signal data path does not exist: {}'.format(self._data_path)
    ...
    def _get_default_path(self):
        """
        Return the default path where signal is expected to be installed.
        """
        return os.path.join(cfg.DATA_DIR, 'vehicle')
    ...
    def gt_roidb(self):
        ...
        """
        cache_file = os.path.join(self.cache_path, 'vehicle_' + self.name + '_gt_roidb.pkl')
    ...
    def _load_annotation(self, index):
        """
        Load image and bounding boxes info from txt file in the synthesis signal file
        format.
        """
    ...
    def _get_voc_results_file_template(self):
        ...
        filename = self._get_comp_id() + 'vehicle_det_' + self._image_set + '_{:s}.txt'
